        ...
        'error',
        {
          ...
          depConstraints: [
            ...
            },
            {
              ...
              onlyDependOnLibsWithTags: ['scope:shared', 'scope:shared-module'],
            },
            {
              sourceTag: 'scope:shared-module',
              onlyDependOnLibsWithTags: ['scope:shared', 'scope:shared-module'],
            },
            {
            ...
            {
              sourceTag: 'package:hooks',
              onlyDependOnLibsWithTags: ['package:tools'],
            },
            {
              sourceTag: 'package:assets',
              onlyDependOnLibsWithTags: ['package:types'],
            },
            {
              sourceTag: 'package:api',
              onlyDependOnLibsWithTags: ['package:types', 'package:tools'],
            },
          ],
        },
      ],
